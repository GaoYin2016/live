 ...
 */
public class RtmpHandler implements INetStreamEventHandler,
		IPendingServiceCallback {

	private static Logger log = Logger.getLogger(RtmpHandler.class);
	...
	public IMessage makeMessageFromTag(ITag tag) {
		IRTMPEvent msg = null;
