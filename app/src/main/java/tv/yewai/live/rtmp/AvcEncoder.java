...
public class AvcEncoder {
    ...
    private H264Package h264Package;
    private long presentationTimeUs;

    ByteArrayOutputStream outputStream = new ByteArrayOutputStream();

    @TargetApi(Build.VERSION_CODES.JELLY_BEAN)
    public AvcEncoder(int width, int height, int framerate, int bitrate,H264Package h264Package,long presentationTimeUs){
        this.h264Package = h264Package;
        ...
        h264Package.addTrack(mediaFormat);
