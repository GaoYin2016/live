...
class ScreenVideoData implements DataWritter
{
	...
	public ScreenVideoData(Bitmap image, int compression)
	{
	...
	private void generateImageBlocks(Bitmap image)
	{
	...
	ScreenVideoDataImageblock addBlock(int block, Bitmap image)
	{
